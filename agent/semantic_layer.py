...
SEMANTIC_SCHEMA: list[dict[str, Any]] = [
    {
        ...
        "description": (
            ...
            "NOTE: This table is at the order-item grain. Multiple rows exist for a single order_id! "
            "Always use aggregation (SUM/COUNT/DISTINCT) when calculating order-level metrics. "
